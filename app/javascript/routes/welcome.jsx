    ...
    <>
      ...
      <div className="container mx-auto max-w-7xl mt-2 mb-2 px-12">
        ...
        <div className="cursor-pointer border border-x-0 transition-colors border-y-white-op-50 hover:bg-white-op-10">
          <div className="grid grid-cols-6 gap-5 py-3 h-[100px] items-start" onClick={e => navigate('/how-tss-works')}>
            ...
            <div className="col-span-2 text-white-op-50 leading-6">
              Do you want to know how tenant screening works?
            </div>
            <div className="col-span-2 pt-1">
              <img src={arrow_right} alt="right arrow" className="block ml-auto" />
            </div>
          </div>
        </div>
