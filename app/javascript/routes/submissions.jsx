        ...
        <div className="lg:grid lg:grid-cols-6 lg:gap-5">
          ...
          <div className="lg:col-span-3">
            <h2 className="font-bold text-4xl">
              { t("Donate your tenant screening report securely, and get a $100 gift card.") }
            </h2>
          ...
          <div className="lg:col-span-3">
            ...
            <ol className="font-bold text-dark-blue list-decimal">
              ...
              <li>
                <Trans i18nKey="submissions.submit_desc_02">
                  Ensure you have an email address. <span className="font-normal text-white-op-70">This is to receive your compensation. After we check the submission is valid, we will send an e-gift card ($100) to your email address.</span> 
                </Trans>
              </li>
            </ol>
            ...
            <Trans i18nKey="submissions.submit_desc_04">
              ...
              <p className="text-white-op-70">
                ...
                <br/><br/>
                For instance, suppose you applied for landlord A got your tenant screening report from the company B, and then applied for landlord C and got your tenant screening report again from B, then you can submit two times and get two $100 gift cards. <br/><br/>
                But in this case, we may ask you to verify the report is indeed generated by landlord C. */}
                Sorry, but due to the institution's rule regarding gift cards, compensation is granted on a per-person basis, not per submission. This means that even if you donated twice, you would receive a $100 gift card, not $200.
              </p>
            </Trans>
